...
function createData(sr, name, quantity, price, amount) {
  ...
  const rows = [
    createData(1,'Boy Choy Cabbage', 1, 15000),
    createData(2,'Organic Purple Cauliflower', 6, 11000),
    createData(3,'Ahold Acorn Squash', 100, 10000)
  ];
    ...
    <Card sx={{ 
        ...
        <Grid item xs>
            <Paper sx={{textAlign: "left"}} elevation={0}>
                <Typography sx={{textTransform: "uppercase", 
                                fontWeight: "bold",
                                color: "#4c4f52",
                                fontSize: "0.875rem"}}>Ngày đăng ký</Typography>
                <Typography sx={{fontSize: "0.875rem", color: "#707275"}}>
        ...
        <Grid item xs>
            ...
            <Typography sx={{textTransform: "uppercase", 
                                fontWeight: "bold",
                                color: "#4c4f52",
                                fontSize: "0.875rem"}}>Mã đăng ký</Typography>
        ...
        <Grid item xs>
            ...
            <Typography sx={{textTransform: "uppercase", 
                                fontWeight: "bold",
                                color: "#4c4f52",
                                fontSize: "0.875rem"}}>Người đăng ký</Typography>
                <Typography sx={{fontSize: "0.875rem", color: "#707275"}}>
